---
title: "Introduction to mapping R"
---
...
```{r, echo=F}
sle_adm3_raw <- sf::read_sf("data/mapping/sle_adm3/sle_adm3.shp")
```
...
```{r}
# Population by ADM3
sle_adm3_pop <- import("data/mapping/sle_admpop_adm3_2020.csv") %>%
  janitor::clean_names()
```
...
sle_hf <- sf::read_sf("data/mapping/sle_adm3/sle_hf.shp") %>% 
  janitor::clean_names() %>%
